...
def lpips_power_transition(perturbations, norm, lpipsdist=0, epsilon=0.3, gamma=1):
    """
    ...
    epsilon = norms*0.03/(lpipsdist+1e-6) # change
    return torch.sigmoid(100*(norms-epsilon)), norms
