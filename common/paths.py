...
BASE_DATA = '/fs/classhomes/fall2021/cmsc828w/cs828w04/confidence-calibrated-adversarial-training'
# base directory for experiments (model files, adversarial examples etc.)
BASE_EXPERIMENTS = '/fs/classhomes/fall2021/cmsc828w/cs828w04/confidence-calibrated-adversarial-training'
# base directory for logs (mainly tensorboard for training)
BASE_LOGS = '/fs/classhomes/fall2021/cmsc828w/cs828w04/confidence-calibrated-adversarial-training'
